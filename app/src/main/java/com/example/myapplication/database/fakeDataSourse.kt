...
class fakeDataSourse :DataBaseInter {
    override fun getSavedArticles(): List<Articles> {
        var title ="CNN"
        var discription = "Why TikTok is taking months to delete personal US user data from servers outside its Project Texas firewalls, even as its political standing sours"
        ...
        var data = Articles(NewsSource("1",title),"ahmed",
